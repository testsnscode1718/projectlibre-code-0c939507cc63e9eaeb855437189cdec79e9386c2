 ...
 */
public class MSPDIWriter extends AbstractProjectWriter
{//claur removed final to extend
   /**
    ...
    * @param project Root node of the MSPDI file
    */
   protected void writeResources(Project project)  //claur changed to protected
   {
    ...
    */
   protected Project.Resources.Resource writeResource(Resource mpx)  //claur changed to protected
   {
   ...
   protected ProjectFile m_projectFile;  //claur changed to protected
